...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:sitecreatorgroup@gmail.com">sitecreatorgroup@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7903793883</li>
					<li class="s-bar">
						<div class="search">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 79037983883</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:sitecreatorgroup@gmail.com">sitecreatorgroup@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> G. Noida, Up, IND.</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 HOTEL SITE . All Rights Reserved | Brought To You by <a href="https://sitecreatorgroup.online/">Site CReator Group</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
